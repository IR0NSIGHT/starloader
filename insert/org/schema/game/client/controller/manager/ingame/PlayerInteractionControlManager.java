...
import api.listener.events.block.BlockPlaceEvent;
...
public class PlayerInteractionControlManager extends AbstractControlManager {
    ...
    public int buildBlock(EditableSendableSegmentController var1, Vector3f var2, Vector3f var3, BuildCallback var4, DimensionFilter var5, SymmetryPlanes var6, float var7) {
        ...
        this.stacked = false;
        var8 = this.checkCanBuild(var1, var6, var8);
            ...
            if (this.getBuildToolsManager().isSelectMode()) {
                ...
                try {
                    ...
                    if (var1.isUsingOldPower() && (var22.isReactorChamberAny() || var22.getId() == 1008 || var22.getId() == 1010 || var22.getId() == 1009)) {
                        ...
                        PlayerContextHelpDialog var27;
                        (var27 = new PlayerContextHelpDialog(this.getState(), EngineSettings.CONTEXT_HELP_PLACED_NEW_REACTOR_ON_OLD_SHIP, var23, true)).ignoreToggle = false;
                        var27.activate();
                        return 0;
                    }
                    ...
                    if (EngineSettings.CONTEXT_HELP_PLACE_MODULE_WITHOUT_COMPUTER_WARNING.isOn()) {
                        SegmentPiece var26 = this.getSelectedBlockByActiveController();
                    ...
                    if (EngineSettings.CONTEXT_HELP_PLACE_CHAMBER_WITHOUT_CONDUIT_WARNING.isOn() && var22.isReactorChamberGeneral() && !this.surroundCondition(var1, var2, var3, var7, var10, new PlayerInteractionControlManager.SurroundBlockCondition() {
                        public boolean ok(ElementInformation var1) {
                            System.err.println(var1 + " INFO SPEC " + var1.isReactorChamberSpecific() + "; placing " + ElementKeyMap.toString(checkCanBuild) + "; block root: " + var1.chamberRoot + "; " + var1.isReactorChamberGeneral() + "; " + checkCanBuild + "; " + var1.id);
                            return var1.id == 1010 || var1.isReactorChamberGeneral() && checkCanBuild == var1.getId() || var1.isReactorChamberSpecific() && checkCanBuild == var1.chamberRoot;
                        }
                    })) {
                    ...
                    int var19 = var1.getNearestIntersection(var8, var2, var3, var4, var28.blockOrientation, var28.activateBlock, var5, var10, var20, var7, var6, var25, var24);
                    if (var19 > 0) {
                    ...
                    if (var14.userData != null) {
                        if (var14.userData instanceof SegmentController) {
                            var23 = ((SegmentController)var14.userData).getRealName();
                        } else if (var14.userData instanceof SimpleTransformableSendableObject) {
                            var23 = ((SimpleTransformableSendableObject)var14.userData).toNiceString();
                        } else if (var14.userData instanceof String) {
                            var23 = (String)var14.userData;
                        }
                    }
                    ...
                    this.getState().getWorldDrawer().getBuildModeDrawer().addBlockedDockIndicator(var15.to, (SegmentController)null, (DockingBlockCollectionManager)null);
                ...
                } catch (BlockNotBuildTooFast var16) {
            ...
            if (var6.getPlaceMode() == 0) {
                ...
                try {
                    ...
                    if (!this.getBuildToolsManager().isCopyMode() && (this.getBuildToolsManager().getBuildHelper() == null || this.getBuildToolsManager().getBuildHelper().placed)) {
                        var9 = var1.getNextToNearestPiece(var2, var3, new Vector3i(), var7, new Vector3i(), new Vector3i());
                    } else {
                        var9 = var1.getNearestPiece(var2, var3, var7, var10, var10);
                    }

                    if (var21 > 0 && var9 != null) {
                        Vector3i var13 = var9.getAbsolutePos(new Vector3i());
                        switch(var21) {
                            case 1:
                                var6.getXyPlane().z = var13.z;
                                var6.setXyPlaneEnabled(true);
                                break;
                            case 2:
                                var6.getXzPlane().y = var13.y;
                                var6.setXzPlaneEnabled(true);
                                break;
                            case 4:
                                var6.getYzPlane().x = var13.x;
                                var6.setYzPlaneEnabled(true);
                                break;
                            case 8:
                                if (this.buildToolsManager.isSelectMode()) {
                                    ...
                                    var6.setPlaceMode(0);
                                    this.getPlayerCharacterManager().getSymmetryPlanes().setPlaceMode(0);
                                }

                                return 0;
                            case 16:
                                if (this.getBuildToolsManager().canPaste()) {
                                    this.getBuildToolsManager().getCopyArea().build(var1, var13, var12, var6);
                ...
                } catch (BlockNotBuildTooFast var18) {
                    var11 = null;
        ...
        if (this.getState().getController().allowedToEdit(var1)) {
            if (var1.isInTestSector()) {
                ...
                if (var1.getHpController().isRebooting()) {
                    ...
                    }, var6, var7, var9, var13, var14, this.moddedSegs);
                    this.moddedSegs.clear();
                    this.getState().getController().queueUIAudio("0022_action - buttons push medium");
